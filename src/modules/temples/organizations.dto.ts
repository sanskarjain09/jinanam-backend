...
export const createOrganizationSchema = z.object({
  body: z.object({
    type: z.enum(['TEMPLE', 'JAIN_CENTER', 'DHARAMSHALA', 'BHOJANSHALA', 'PATHSHALA', 'COMMUNITY_HALL', 'TRUST_OFFICE', 'STHANAK', 'GAUSHALA']),
    name: z.string().min(1),
    ...
    childOrganizationIds: z.array(z.string()).optional(),
    ...
    eventHallImages: z.any().optional(),
