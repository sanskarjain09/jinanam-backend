...
export const registerJainMemberSchema = z.object({
  body: z.object({
    ...
    favouriteTempleId: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
    favouriteDharamshalaId: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
    favouriteBhojanshalaId: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
